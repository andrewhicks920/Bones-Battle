...
public class GameConfig {
    ...
    private GameConfig(ArrayList<String> playerNames, boolean tournament, int victory, int speedOfPlay, int mapGaps) {
    ...
    public static GameConfig fromArgs(String[] args) {
        ...
        if (nameList.isEmpty()) {
            ...
            String[] defaultNames = {"Altos", "Amstrad", "Bondwell", "Cromemco", "Heathkit", "Kaypro", "Osborne", "Sinclair", "Tandy"};
            ...
            for (String stratName : nameList) {
                ...
                if (!classFile.exists() || !classFile.canRead()) {
                    allValid = false;
                    System.out.println("ERROR: Strategy " + stratName + ".class either doesn't exist or can't be read.");
                }
            }
            ...
            System.out.println("""
                    Arguments are to be names of strategy .class files.
                    Include 'human' if you wish to play against the computer players.
                    List 2, 3, 4, or 5 names.  No arguments defaults human playing against 4 computer players.
